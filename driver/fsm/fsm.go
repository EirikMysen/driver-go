...
func OnReQuestButtonPress(button elevio.ButtonEvent, elevator_M elevator.Elevator, timer *time.Timer, duration time.Duration) elevator.Elevator {
	print("OnRequestButtonPress is running! \n")
	switch {
	case elevator_M.Behav == elevator.EB_DoorOpen:
		print("Door_Open \n")
	...
	case elevator_M.Behav == elevator.EB_Moving:
		print("Door_Moving \n")

		elevator_M.Requests[button.Floor][button.Button] = 1

	case elevator_M.Behav == elevator.EB_Idle:
		print("Idle \n")
...
func Fsm_OnFloorArrival(elevator_M elevator.Elevator, timer *time.Timer, duration time.Duration, newFloor int) elevator.Elevator {
...
func Fsm_OnDoorTimeout(elevator_M elevator.Elevator, timer *time.Timer, duration time.Duration) elevator.Elevator {
